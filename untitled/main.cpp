...
int main(int argc, char argv[]){
    ...
    listaArticuloslistaArt = new listaArticulos();
    ...
    FabricaB= new Fabrica(listaArt, colaAlisto, colaB,"B",s,"Fabrica B");
    Fabrica C= new Fabrica(listaArt, colaAlisto, colaC,"C",s,"Fabrica C");
    FabricaComodin= new Fabrica(listaArt, colaAlisto, colaComodin,"A","B",s,"Fabrica Comodin");
